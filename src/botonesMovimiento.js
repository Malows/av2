...
export function botonesNavegacion ({ x, y }) {
    ...
    if (oeste !== estadoBotonOeste)
        Orientacion.oeste = estadoBotonOeste = oeste

    if (este !== estadoBotonEste)
        Orientacion.este = estadoBotonEste = este

    if (sur !== estadoBotonSur)
        Orientacion.sur = estadoBotonSur = sur

    if (norte !== estadoBotonNorte)
        Orientacion.norte = estadoBotonNorte = norte
